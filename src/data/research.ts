...
export const CURRENT_RESEARCH: ResearchProject[] = [
  ...
  },
  {
    ...
    sections: {
      ...
      data: "GX 339−4 has an orbital period of approximately 1.76 days, making it impossible to observe a complete orbit within a single ground-based observing block. Instead, the system was monitored with Swift/BAT to identify periods of X-ray quiescence, when contamination from the accretion flow was expected to be minimised. During these quiescent intervals, HAWK-I observations were obtained opportunistically across the observing season whenever suitable scheduling windows became available. The aim was to build a set of approximately 20 epochs sampling different orbital phases; these observations could then be phase-folded on the known orbital period to provide sufficiently broad coverage for reconstruction and modelling of the orbital light curve.",
      methods: [
